...
/**
 * Offline short-links (printed business cards, t-shirts, stickers): a short,
 ...
 * the visitor on e.g. `/en?utm_source=tshirt…` in their detected language.
 *
 * Keys are lowercase, trailing-slash-stripped paths. Add new cards/merch here.
 */
const SHORT_LINKS: Record<string, string> = {
  "/card": "utm_source=tshirt&utm_medium=offline&utm_campaign=networking",
};
